...
$(function() {
  ...
  if(windowSize < 640) {
    ...
    resultHref = '/heart_c/sp/index_c.html?argument=2JbemGXQ&dmai=a5f0e6c6a32d47';
  } else {
    footerHref = 'https://orientalbio-kenko.jp/epa/data.html';

    resultHref = '/heart_c/index_c.html?argument=2JbemGXQ&dmai=a5f0e6c6a32d47';
  }
  $('#footer .links a').attr('href', footerHref);
  $('#result a').attr('href', resultHref);
});
...
// 診断
{
  ...
  submitBtn.addEventListener('click', () => {
    ...
    if(scoreYes >= 1) {
      resultText.textContent = `${scoreYes} / ${items.length}問当てはまった\nあなたは、要注意！`;
